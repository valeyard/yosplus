...
function setCats(theData) {
  safari.self.tab.dispatchMessage("cats",theData);
}

function setIglist(theData) {
  safari.self.tab.dispatchMessage("iglist",theData);
}

function setFflist(theData) {
  safari.self.tab.dispatchMessage("fflist",theData);
}

function setAll(theData) {
  safari.self.tab.dispatchMessage("all",theData);
}


function setOldbread(theData) {
  safari.self.tab.dispatchMessage("oldbread",theData);
}
...
function getAnswer(theMessageEvent) {
    if (theMessageEvent.name === "theAnswer") {
        ...
        console.log(JSON.parse(calculatedVal));
        var g = JSON.parse(calculatedVal);
        console.log(g)
        var next;
        ...
        //show/hide avatar
        if (g.avatarHide == undefined) g.avatarHide = true;
        ...
        //     }))
            ...
            // var qs = jQuery.param.querystring();
            ...
            //   })
              ...
              $('.showImages').click(function(event) {
                ...
                if (thisForum == 219) {
                  if (g.snype == undefined) g.snype = true;
                  ...
                  if (g.avatarHideOption == false) $(".title").show()
                    ...
                    if (g.avatarHideOption) {
                      $(".userinfo").click(function(event) {
                        ...
                        setAvatarHide(JSON.stringify(jet));
                      });
                    }
                            ...
                            if (g.tree) {
                              ...
                              $("#forums").click(function(event) {
                                ...
                                if ($this.attr("class") == "category") {
                                  ...
                                  console.log("oldbread")
                                  console.log(g.oldbread)
                                  if (g.oldbread == undefined) g.oldbread = true;
                                  setOldbread(JSON.stringify(g.oldbread
                                  ));
                                  if (g.oldbread) {
...
$(document).ready(function() {
  if (window.top === window) doBigCalc(initialVal);
});
