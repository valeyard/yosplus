...
function handleDrop(e) {
  ...
  if (dragSrcEl != this) {
    ...
    $('.standard').find('.smilie_group').append('<li class="smilie" draggable="true"> '+ dragSrcEl.innerHTML);
...
$(".post").each(function(index, image) { //vine embed
	$this = $(image);
	//var text = this.rows[0].innerText;
	var text = $(this).find(" td.postbody")[0].innerText;
 ...
 // $this = $(this.rows);
	...
	//console.log(x.test("https://vine.co/v/h3Wm0PaxEpM someword"));
	//var url = x.exec("https://vine.co/v/h3Wm0PaxEpM someword");
	//console.log(url);
      //console.log(this.length);
      //console.log("owned async");
      text = text.replace(/\"/g,"&quot;");
